  ...
  return (
    <div className='bg-white w-160 p-16 flex flex-col justify-center items-center mx-auto'>
      ...
      <p className="text-center mb-8">
        Your Order is recordedin our system, we are still confirming the payment status, please wait and your order status will be updated in less than 12 hours.
      </p>
